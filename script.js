...
const heroRoleOptions = [
  {
    role: "タンク",
    heroes: ["D.Mon", "D.Va", "ウィンストン", "オリーサ", "ザリア", "シグマ", "ジャンカー・クイーン", "ドゥームフィスト", "ドミナ", "ハザード", "マウガ", "ラインハルト", "ラマットラ", "レッキング・ボール", "ロードホッグ"]
  },
  {
    role: "ダメージ",
    heroes: ["アッシュ", "アンラン", "ウィドウメイカー", "ヴェンデッタ", "エコー", "エムレ", "キャスディ", "ゲンジ", "シンメトラ", "ジャンクラット", "ソジョーン", "ソルジャー76", "ソンブラ", "トレーサー", "トールビョーン", "ハンゾー", "バスティオン", "ファラ", "フレイヤ", "シエラ", "シオン", "ベンチャー", "ベンチャー", "メイ", "リーパー"]
  },
  {
    role: "サポート",
    heroes: ["アナ", "イラリー", "ウーヤン", "キリコ", "ジェットパック・キャット", "ジュノ", "ゼニヤッタ", "バティスト", "ブリギッテ", "ミズキ", "マーシー", "モイラ", "ライフウィーバー", "ルシオ"]
  }
];
